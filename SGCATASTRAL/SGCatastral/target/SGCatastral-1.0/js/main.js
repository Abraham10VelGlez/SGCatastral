      ...
      // alert("continuar con el proceso");
                 ...
                 // alert(wy);    
                  ...
                  $.each(encapsularjson,function (contador1,item){
                                    ...
                                    $('#edificio').val('00');
                                    $('#depa').val('0000');
                                    $('#cve_cat').val(encapsularjson[contador1].mun+encapsularjson[contador1].zona+encapsularjson[contador1].manz+encapsularjson[contador1].pre+'00'+'0000');
                  ...
                  // alert(valink);
                   ...
                   var jsonsavkyekey = jQuery.parseJSON(valink);                 
                     ...
                     $('#keypreed').val(jsonsavkyekey[i].valorresultante);
                       ...
                       alert('Predio Guardado con Exito, continuar');   
...
alert('Datos Guardados con exito,continuar...  Haz clic que Calcular CVT');
...
agregacerosmanzanas(jsonscla[i].manzanaa);
agregarmotivo();
});
});   
}
...
function agregacerosmanzanas(n){
    //(n, length)
//    (n,length)
//var     n=1000;
var length=3;
...
function agregarmotivo(){
    $('#motivo').val('INCORPORACIÓN AL PADRÓN');
}