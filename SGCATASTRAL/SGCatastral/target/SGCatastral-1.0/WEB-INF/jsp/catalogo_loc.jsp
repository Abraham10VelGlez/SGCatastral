<%-- 
    Document   : catalogo_loc
    Created on : 1/12/2017, 03:31:09 PM
    Author     : Fernando
--%>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="barranavegacion">
                                <ul class="links nav navbar-nav" id="main-menu">
                                    ...
                                    <!--li class="menu-1289"><a href="acercade.do">Acerca de SGC</a></-->
                ...
                <div class="container">
                    <div id="menu_izq">
                        ...
                        <div class="content_menu_izq">
                            <ul class="menu_ul">
                                <li class="menu_li"><a href="catalogo_mun.do">Catálogo Municipio</a></li>
                                <li class="menu_li"><a href="catalogo_loc.do">Catálogo Localidades</a></li>
                                <li class="menu_li"><a href="catalogo_zonas.do">Catálogo Zonas</a></li>
                                <li class="menu_li"><a href="catalogo_mzna.do">Catálogo Manzanas </a></li>
                                <li class="menu_li"><a href="catalogo_predio.do">Catálogo Predios </a></li>                  
                                <li class="menu_li"><a href="catalogo_col.do">Catálogo Colonias</a></li>
                                <li class="menu_li"><a href="catalogo_ah.do">Catálogo Áreas Homogéneas</a></li>
                                <li class="menu_li"><a href="catalogo_ecalle.do">Catálogo Ejes de calle </a></li>                             
